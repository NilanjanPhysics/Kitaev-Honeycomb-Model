...
##########################################################################################################################################
# mu = 0                                      # Spin Flip at mu-th unit cell (z-type unit cell)! : mu = 0 implies, (4,16) for 4*4 lattice! 
...
plt.legend()
plt.tight_layout()
# plt.savefig("0-flux_GS_energy_perunitcell_vs_systemsize.pdf", bbox_inches="tight")
plt.show()

############ Similarly You Can Plot Everything and see and compare the Results to that what Kitaev have given in page: 45 of his paper ##
